                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row col-md-6 mb-3 mt-3">
                                            ...
                                            <div class="row">
                                                ...
                                                <input type="text" name="txt_fname" class="form-control" id="validationTooltip01" placeholder="First name" readonly value="<?php echo $first_name?>" required>
                                                ...
                                                <input type="text" name="txt_lname" class="form-control" id="validationTooltip02" placeholder="Last name" readonly value="<?php echo $last_name ?>" required>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                                </div>
