<script type="text/javascript">
  ...
  function rightAuth()
  {
    location.replace("/online-banking/site/dist/index.php");
  }
...
<html lang="en">
  ...
  <body class="bg-primary bg-pattern">
    <div class="home-btn d-none d-sm-block">
            <a href="/online-banking/admin/dist/auth-login.php"><i class="mdi mdi-home-variant h2 text-white"></i></a>
        </div>
          ...
          <div class="col-lg-12">
            <div class="text-center mb-5">
              ...
              <h5 class="font-size-16 text-white-50 mb-4">
                BANK RASMI REPUBLIK FEDERAL CHESKA
              </h5>
            </div>
          </div>
        </div>
