<script type="text/javascript">
  ...
  function rightAuth()
  {
    location.replace("/online-banking/admin/dist/index.php");
  }
...
<html lang="en">
  ...
  <body class="bg-primary bg-pattern">
    <div class="home-btn d-none d-sm-block">
            <a href="/online-banking/site/dist/auth_login.php"><i class="mdi mdi-home-variant h2 text-white"></i></a>
        </div>
              ...
              <div class="card-body p-4">
                <div class="p-2">
                  <h5 class="mb-5 text-center">
                    Sign in to continue to BANK NEGARA CHESKA.
                  </h5>
...
<?php
  ...
  if(isset($_REQUEST['btn_submit']))
  {
    ...
    if(mysqli_num_rows($result1) > 0 )
    {
      ...
      header("location:/online-banking/admin/dist/index.php");
